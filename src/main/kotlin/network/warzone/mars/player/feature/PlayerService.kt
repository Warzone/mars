...
object PlayerService {
    ...
    suspend fun logout(playerId: UUID, playerName: String, sessionId: UUID, playtime: Long) {
    ...
    data class PlayerLogoutRequest(val player: SimplePlayer, val sessionId: UUID, val playtime: Long)
