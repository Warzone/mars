...
object BloodBathAchievement {
    fun createBloodBathAchievement(target: Int, achievement: Achievement, titleName: String) : AchievementAgent =
        object : AchievementAgent, Listener {
            override var match: Match? = null
            override val title: String = titleName
            override val description: String = "Obtain ${target} first-blood kills."
            ...
            fun onPlayerDeath(event: MatchPlayerDeathEvent) = runBlocking {
                ...
                if (profile.stats.firstBloods >= target) {
