...
class PlayerCommands {
    @Command(aliases = ["lookup", "alts", "lu"], desc = "Lookup player information & alts", perms = ["mars.lookup"])
    ...
    @Command(aliases = ["notes", "note"], desc = "Record staff notes on players", perms = ["mars.notes"])
    fun onNotes(
